...
struct LayoutTwo: View {
    ...
    var body: some View {
        ...
        HStack(spacing: 4) {
            if (cards != nil) {
                imageContent(url: cards![0], width: ((width / 3)), height: 125, cardIndex: 0)
                
                if cards!.count >= 2 {
                    imageContent(url: cards![1], width: ((width / 3)), height: 125, cardIndex: 1)
                }
                
                if cards!.count == 3 {
                    imageContent(url: cards![2], width: ((width / 3)), height: 125, cardIndex: 2)
                }
            }
        }
...
//struct LayoutTwo_Previews: PreviewProvider {
